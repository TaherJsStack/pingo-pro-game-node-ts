...
const invoiceMenuSchema = new mongoose_1.Schema({
...
invoiceMenuSchema.methods.updateTotal = function () {
...
exports.default = mongoose_1.default.model('invoiceMenu', invoiceMenuSchema);
