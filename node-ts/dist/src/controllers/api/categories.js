...
const getAllItems = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const items = yield category_1.default.find({ brancheId }).sort({ type: -1, activeState: -1, createdAt: -1 });
        res.status(201)
            .json({
            success: true,
            errors: [],
...
const getAllItemsPagination = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const items = yield category_1.default.find(filter)
            .skip((+page - 1) * +limit)
            .limit(+limit);
        // Count total number of items (for pagination)
        const totalCount = yield category_1.default.countDocuments(filter);
        res.status(200).json({
            success: true,
            data: {
                items,
...
const getItemById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const item = yield category_1.default.findById(req.params.id);
        if (!item) {
...
const updateCategoryStopAllCategoresReletedToBill = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedItems = yield category_1.default.updateMany({ _id: { $in: objectIds } }, { $set: { bookState: false } });
        if (!updatedItems) {
...
const updateItem = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedItem = yield category_1.default.findByIdAndUpdate(req.params.id, req.body, { new: true });
        if (!updatedItem) {
            res.status(404).json({ msg: 'Item not found' });
        }
        res.status(201)
...
const deleteItem = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const deletedItem = yield category_1.default.findByIdAndDelete(req.params.id);
        if (!deletedItem) {
            res.status(404).json({ msg: 'Item not found' });
        }
        res.status(201)
