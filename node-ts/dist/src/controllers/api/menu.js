...
const getAllItems = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const items = yield menu_1.default.find({ brancheId }).sort({ type: -1, activeState: -1, createdAt: -1 });
        res.status(201).json({
            success: true,
            errors: [],
            status: 200,
...
const getAllItemsPagination = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // }
        const items = yield menu_1.default.find(filter)
            .skip((page - 1) * limit)
            .limit(limit);
        const totalCount = yield menu_1.default.countDocuments(filter);
        res.status(200).json({
            success: true,
            data: {
                items,
...
const getItemById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const item = yield menu_1.default.findById(req.params.id);
        if (!item) {
...
const updateItem = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const updatedItem = yield menu_1.default.findByIdAndUpdate(req.params.id, req.body, { new: true });
        if (!updatedItem) {
            return res.status(404).json({ msg: 'Item not found' });
        }
        res.status(201).json({
...
const deleteItem = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const deletedItem = yield menu_1.default.findByIdAndDelete(req.params.id);
        if (!deletedItem) {
            return res.status(404).json({ msg: 'Item not found' });
        }
        res.status(201).json({
