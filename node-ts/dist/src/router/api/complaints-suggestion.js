...
const complaints_suggestion_1 = require("../../controllers/api/complaints-suggestion");
// import checkAuth from '../../middleware/check-auth';
const sign_req_data_1 = __importDefault(require("../../middleware/sign-req-data"));
const router = express_1.default.Router();
const controller = new complaints_suggestion_1.ComplaintsSuggestionController();
// Route: POST /items (Create item)
router.post('', sign_req_data_1.default, [
    // Validation rules using express-validator
    (0, express_validator_1.check)('brancheId').notEmpty().withMessage('branchId is required'),
