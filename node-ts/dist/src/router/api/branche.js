...
const BrancheController = __importStar(require("../../controllers/api/branche"));
...
router.post('', sign_req_data_1.default, [
    ...
    yield BrancheController.createItem(req, res);
}));
...
router.put('/:id', [
    ...
    yield BrancheController.updateItem(req, res);
}));
