...
import InvoiceMenuModel, { IInvoiceMenuItem, IInvoiceMenu } from '../../models/invoice-menu';
...
// Update - PUT request handler
export const updateMenuItemsLockOrders = async (req: CreateItemRequest, res: Response): Promise<void> => {
  try {
...
// Update - PUT request handler
export const updateMenuItems = async (req: Request, res: Response): Promise<void> => {
  try {
    // Update item by ID in database
    const updatedItem = await InvoiceMenuModel.findByIdAndUpdate(
      req.params.id,
