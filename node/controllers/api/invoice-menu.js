const InvoiceMenuModel = require('../../models/invoice-menu');
...
exports.createItem = async (req, res) => {
  ...
  try {
    ...
    let newItem = new InvoiceMenuModel(req.body);
...
//     const updatedItems = await InvoiceMenuModel.updateMany(
//       { _id: { $in: objectIds } },
//       { $set: { bookState: false } }
//     );
...
// Update - PUT request handler
exports.updateMenuItemsLockOrders = async (req, res) => {
  try {
    req.body['closedBy'] = req.authData.id;
